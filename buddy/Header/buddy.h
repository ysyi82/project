...
#define PAGE_SIZE		(1UL << PAGE_SHIFT) //[00001000] 4096byte //page size 32 byte
#define PAGE_MASK		(~(PAGE_SIZE-1))    //[fffff000]
#define PAGE_ALIGN(addr)	(((addr)+PAGE_SIZE-1)&PAGE_MASK) //(addr+00000111)&fffff000->앞부분fffff부분만 유효
